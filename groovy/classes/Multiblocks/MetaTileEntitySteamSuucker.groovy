...
public class MetaTileEntitySteamSuucker extends RecipeMapSteamMultiblockController {
    
    //Parallel ammount
    private static final int PARALLEL_LIMIT = 8;
    
    //constructor
    public MetaTileEntitySteamSuucker(ResourceLocation metaTileEntityId){
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntitySteamSuucker(metaTileEntityId)
    }
    ...
    protected BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start() 
                ...
                .where('B' as char, states(MetaBlocks.BOILER_CASING.getState(BoilerCasingType.BRONZE_PIPE)))
                .where('#' as char, air())
                .build()
    }
