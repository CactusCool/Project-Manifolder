...
public class MetaTileEntitySteamAlloyFactory extends RecipeMapSteamMultiblockController {    
    
    //Parallel ammount
    private static final int PARALLEL_LIMIT = 8;
    
    //constructor
    public MetaTileEntitySteamAlloyFactory(ResourceLocation metaTileEntityId){
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntitySteamAlloyFactory(metaTileEntityId)
    }
    ...
    protected BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start() 
                .aisle("XXX####", "XXX####", "XXX####")
                .aisle("XXX#FFF", "XGX#XXX", "XXX#XXX")
                .aisle("XXX#FXF", "XGXXX#X", "XXX#X#X")
                .aisle("XXX#FFF", "XSX#XXX", "XXX#XXX")
                ...
                .where('F' as char, states(MetaBlocks.BOILER_FIREBOX_CASING.getState(FireboxCasingType.BRONZE_FIREBOX)))
